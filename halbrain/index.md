...
- [[skills/supabase-prod-migration-route]] — supabase · provisional — how a migration actually reaches prod (SQL editor, transaction-wrapped) and how to prove it landed via PostgREST.

## Knowledge
- [[knowledge/orientation]] — current (2026-07-24)
- [[knowledge/superseded]] — current (2026-07-31, DB-credential correction)
- [[knowledge/features]] — current (2026-07-31, full audit)
- [[knowledge/roadmap]] — current (2026-07-31, includes 10-defect triage)

## Recent journal
- [[journal/2026-07-31]] — audit (13 defects) → defect sweep → Blend viral loop → migration 012 applied to prod; second consolidation.
